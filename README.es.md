...
<p align="center">
  ...
  <img src="screenshots/en/26-settings.png" alt="Ajustes">
</p>
...
- **387 módulos de comandos** — Comandos de IA, aplicaciones, juegos, sistema y sitios web siempre a mano, y basta un archivo JSON para añadir los suyos.
...
| **Inicio y eficiencia** | Dock · Historial del portapapeles · Estadísticas de uso · Captura de pantalla · Grabación de pantalla · Asistente de recordatorios · Calendario perpetuo · Acciones rápidas del sistema · Gestos del ratón · Escaneo y limpieza de archivos relámpago · Análisis de espacio en disco relámpago · Limpieza de memoria relámpago · Optimizador de sistema relámpago |
| **Texto e idiomas** | Traducción avanzada · Reconocimiento de texto OCR · OCR rápido · Expresiones regulares · Codificar y decodificar · Cálculo de hash · Cifrado y descifrado · Conversión de datos · Generación de datos |
...
| **Cálculo y extensiones** | Hoja de cálculo libre · Códigos QR · SDK abierto · Navegador integrado |
| **Personalización** | Fondo de pantalla dinámico · Efectos de escritorio · Página de navegación |
...
| `yyzScreenCap.exe`   | Captura de pantalla — región, desplazamiento y fijar en pantalla |
| `yyzScreenRec.exe`   | Grabación de pantalla — cámara que sigue el cursor, clics y teclas en pantalla |
| `yyzFileClean.exe`   | Escaneo y limpieza de archivos relámpago (ImGui) |
| `yyzDiskSpace.exe`   | Análisis de espacio en disco relámpago (ImGui) |
| `yyzMemClean.exe`    | Limpieza de memoria relámpago (ImGui) |
| `yyzWinOpt.exe`      | Optimizador de sistema relámpago (ImGui) |
