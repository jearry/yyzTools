...
- **安装包**（推荐）：`yyzTools-setup-1.0.0.1000.exe` —— [GitHub Releases](https://github.com/jearry/yyzTools/releases)
...
安装向导支持简体中文、繁体中文、英语、日语、韩语、法语、德语、西班牙语、俄语、阿拉伯语 10 种语言。
...
界面与命令模块文案均支持上述 10 种语言；首次启动按系统语言自动匹配，可在设置中切换。
