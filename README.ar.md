...
- **388 وحدة أوامر** — أوامر جاهزة في خمس فئات: الذكاء الاصطناعي والتطبيقات والألعاب والنظام والمواقع، ويكفي ملف JSON واحد لإضافة أوامرك الخاصة.
...
| **التشغيل والإنتاجية** | الرصيف · سجل الحافظة · إحصاءات التطبيقات · التقاط الشاشة · تسجيل الشاشة · مساعد التذكيرات · التقويم الدائم · تلميحات المفاتيح · تحديد موقع الفأرة · مسح وتنظيف الملفات الخاطف · مُحلِّل مساحة القرص الخاطف · مُنظِّف الذاكرة الخاطف · مُحسِّن النظام الخاطف |
...
- **حزمة التثبيت** (مستحسنة): `yyzTools-setup-1.0.9.1900.exe` —— [GitHub Releases](https://github.com/jearry/yyzTools/releases)
