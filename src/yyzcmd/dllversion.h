...
#define TEXT_PRODUCTNAME       yyzCmd
#define TEXT_FILEDESC          yyzTools yyzCmd
#define TEXT_COMPANY           www.yyztools.com
#define TEXT_MODULE            yyzCmd.exe
#define TEXT_COPYRIGHT         Copyright (C) DRV_YEAR TEXT_COMPANY
#define TEXT_INTERNALNAME      yyzCmd.exe
