...
#define TEXT_PRODUCTNAME       yyzMouseFinder
#define TEXT_FILEDESC          yyzTools yyzMouseFinder
#define TEXT_COMPANY           www.yyztools.com
#define TEXT_MODULE            yyzMouseFinder.exe
#define TEXT_COPYRIGHT         Copyright (C) DRV_YEAR TEXT_COMPANY
#define TEXT_INTERNALNAME      yyzMouseFinder.exe
