...
- **388 módulos de comandos** — Comandos de cinco categorias (IA, aplicações, jogos, sistema e sites) prontos a usar; basta um ficheiro JSON para adicionar os seus.
...
| **Arranque e produtividade** | Dock · Histórico da área de transferência · Estatísticas de aplicações · Captura de ecrã · Gravação de ecrã · Assistente de lembretes · Calendário permanente · Indicação de teclas · Localização do rato · Varredura e limpeza de arquivos relâmpago · Análise de espaço em disco relâmpago · Limpeza de memória relâmpago · Otimizador de sistema relâmpago |
...
- **Instalador** (recomendado): `yyzTools-setup-1.0.8.1800.exe` —— [GitHub Releases](https://github.com/jearry/yyzTools/releases)
